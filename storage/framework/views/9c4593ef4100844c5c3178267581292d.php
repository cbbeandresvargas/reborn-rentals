<?php $__env->startSection('title', 'Reborn Rentals - Home'); ?>
...
<div class="bg-[#414141] py-3 sm:py-2 md:py-1 shadow-md sticky top-0 sm:relative z-[8]">
    <div class="max-w-7xl mx-auto px-4 sm:px-4 md:px-6">
        <div class="flex flex-row items-center gap-3 sm:gap-4 md:gap-5">
            ...
            <div class="relative flex-shrink-0">
                <button type="button" id="filters-toggle-btn" class="flex items-center justify-center gap-2 bg-transparent p-2.5 sm:px-3 sm:px-4 sm:py-2 sm:py-3 rounded-lg transition-all duration-200 shrink-0 group cursor-pointer touch-manipulation active:scale-95">
                    <div class="relative w-7 h-7 sm:w-6 sm:h-6 md:w-7 md:h-7">
                        <img src="<?php echo e(asset('icons/filters.svg')); ?>" alt="Filters" class="absolute inset-0 w-full h-full object-contain transition-opacity duration-300 ease-in-out group-hover:opacity-0" />
                        <img src="<?php echo e(asset('icons/filters-hover.svg')); ?>" alt="Filters Hover" class="absolute inset-0 w-full h-full object-contain transition-opacity duration-300 ease-in-out opacity-0 group-hover:opacity-100" />
                    </div>
                </button>
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        <form id="filters-form">
                            <div class="flex flex-col gap-2.5 sm:gap-3 max-h-[calc(100vh-300px)] sm:max-h-96 overflow-y-auto">
                                <?php if(isset($productDescriptions) && count($productDescriptions) > 0): ?>
                                    ...
                                    <label class="flex items-start gap-2.5 sm:gap-3 cursor-pointer group hover:bg-[#4A4A4A] active:bg-[#4A4A4A] p-2.5 sm:p-2 rounded transition-colors touch-manipulation">
                                        <input type="checkbox" name="descriptions[]" value="<?php echo e($description); ?>" <?php echo e(in_array($description, request('descriptions', [])) ? 'checked' : ''); ?> class="w-5 h-5 sm:w-4 sm:h-4 border-2 border-white rounded bg-transparent text-[#CE9704] focus:ring-[#CE9704] focus:ring-2 cursor-pointer mt-0.5 sm:mt-1 flex-shrink-0 touch-manipulation" />
                                        <span class="text-white text-sm sm:text-sm leading-relaxed group-hover:text-[#CE9704] transition-colors duration-300 flex-1"><?php echo e($description); ?></span>
                                    </label>
            ...
            <form method="GET" action="<?php echo e(route('home')); ?>" class="flex-1 w-full sm:w-auto hidden" id="search-form">
                <div class="relative">
                    <input
                        type="text"
                        name="search"
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-14 mt-6 sm:mt-10 md:mt-14 lg:mt-20 mb-12 sm:mb-16 md:mb-20 lg:mb-24">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 md:gap-6 lg:gap-7 xl:gap-8" id="products-grid">
        <?php echo $__env->make('partials.products-grid', ['products' => $products], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
...
(function() {
    ...
    function applyFilters() {
        ...
        // Make request
        const requestUrl = '<?php echo e(route("home")); ?>?' + params.toString();
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\FABRICIORENECRESPORO\Desktop\Rentals\reborn-rentals\resources\views/home.blade.php ENDPATH**/ ?>