    ...
    <div class="px-4 sm:px-6 py-6 sm:py-8 min-h-full flex flex-col">
        ...
        <div class="flex justify-between items-center mb-10 shrink-0">
            <div class="flex justify-start">
                <img src="<?php echo e(asset('Logo.png')); ?>" alt="Reborn Rentals" class="h-12 w-auto object-contain" />
            </div>
            <button type="button" class="bg-none border-none cursor-pointer p-2 sm:p-3 rounded-lg transition-colors duration-300 ease-in-out hover:bg-white/10 text-white" id="close-menu">
                <img src="<?php echo e(asset('icons/close.svg')); ?>" alt="Close" class="w-6 h-6 sm:w-7 sm:h-7 object-contain" />
            </button>
        </div>
        ...
        <div class="flex flex-col gap-8 flex-1">
            ...
            <div>
                ...
                <nav class="flex flex-col gap-3 ml-4">
                    <a href="<?php echo e(route('about')); ?>" class="text-white no-underline text-sm hover:text-[#CE9704] transition-colors duration-300 py-1 block w-full text-left">About Us</a>
                    <a href="<?php echo e(route('faq')); ?>" class="text-white no-underline text-sm hover:text-[#CE9704] transition-colors duration-300 py-1 block w-full text-left">FAQ</a>
            ...
            <div>
                ...
                <nav class="flex flex-col gap-3 ml-4">
                    <a href="<?php echo e(route('sitemap')); ?>" class="text-white no-underline text-sm hover:text-[#CE9704] transition-colors duration-300 py-1 block w-full text-left">Site Map</a>
                    <a href="<?php echo e(route('blog')); ?>" class="text-white no-underline text-sm hover:text-[#CE9704] transition-colors duration-300 py-1 block w-full text-left">Blog</a>
            ...
            <div>
                ...
                <nav class="flex flex-col gap-3 ml-4">
                    <a href="<?php echo e(route('terms')); ?>" id="terms-link" class="text-white no-underline text-sm hover:text-[#CE9704] transition-colors duration-300 py-1 block w-full text-left">Terms & Conditions</a>
                    <a href="<?php echo e(route('privacy')); ?>" id="privacy-link" class="text-white no-underline text-sm hover:text-[#CE9704] transition-colors duration-300 py-1 block w-full text-left">Privacy Policy</a>
                    <a href="<?php echo e(route('fees')); ?>" id="fees-link" class="text-white no-underline text-sm hover:text-[#CE9704] transition-colors duration-300 py-1 block w-full text-left">Fees & Surcharges</a>
                    <a href="<?php echo e(route('sms')); ?>" id="sms-link" class="text-white no-underline text-sm hover:text-[#CE9704] transition-colors duration-300 py-1 block w-full text-left">SMS Policy</a>
                    </nav>
            </div>
        ...
        <div class="mt-auto pt-6 pb-6 shrink-0 border-t border-gray-600">
            ...
            <div class="flex justify-start mb-6">
                <img src="<?php echo e(asset('icons/cards.svg')); ?>" alt="Payment Methods" class="max-w-full h-auto" />
            </div>
...
<?php /**PATH C:\Users\FABRICIORENECRESPORO\Desktop\Rentals\reborn-rentals\resources\views/components/menu-sidebar.blade.php ENDPATH**/ ?>