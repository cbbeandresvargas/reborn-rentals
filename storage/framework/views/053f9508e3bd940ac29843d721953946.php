        ...
        <div class="flex justify-between items-center relative">
            ...
            <div class="shrink-0 z-10 relative">
                <a href="<?php echo e(route('home')); ?>" class="block">
                    <img src="<?php echo e(asset('Logo.png')); ?>" alt="Reborn Rentals" class="h-7 sm:h-8 md:h-10 w-auto object-contain" />
                </a>
            </div>
            ...
            <div class="flex items-center gap-2 md:gap-4 relative z-10">
                ...
                <button type="button" class="bg-none border-none text-white cursor-pointer p-2 rounded-lg transition-all duration-300 ease-in-out flex items-center justify-center hover:bg-white/10 hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-white/20 relative z-10 group" id="cart-btn" aria-label="Carrito">
                    <div class="relative w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9">
                        <img src="<?php echo e(asset('icons/cart.svg')); ?>" alt="Cart" class="absolute inset-0 w-full h-full object-contain transition-opacity duration-300 ease-in-out group-hover:opacity-0" />
                        <img src="<?php echo e(asset('icons/cart-hover.svg')); ?>" alt="Cart Hover" class="absolute inset-0 w-full h-full object-contain transition-opacity duration-300 ease-in-out opacity-0 group-hover:opacity-100" />
                    </div>
                ...
                <button type="button" class="bg-none border-none text-white cursor-pointer p-2 rounded-lg transition-all duration-300 ease-in-out flex items-center justify-center hover:bg-white/10 hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-white/20 relative z-10 group" id="menu-btn" aria-label="Menu">
                    <div class="relative w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8">
                        <img src="<?php echo e(asset('icons/burger.svg')); ?>" alt="Menu" class="absolute inset-0 w-full h-full object-contain transition-opacity duration-300 ease-in-out group-hover:opacity-0" />
                        <img src="<?php echo e(asset('icons/burger-hover.svg')); ?>" alt="Menu Hover" class="absolute inset-0 w-full h-full object-contain transition-opacity duration-300 ease-in-out opacity-0 group-hover:opacity-100" />
                    </div>
                </button>
            </div>
        </div>
...
<?php /**PATH C:\Users\FABRICIORENECRESPORO\Desktop\Rentals\reborn-rentals\resources\views/components/header.blade.php ENDPATH**/ ?>