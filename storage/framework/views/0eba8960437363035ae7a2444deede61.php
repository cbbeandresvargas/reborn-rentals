<?php $__env->startSection('title', 'Select Jobsite & Time - Reborn Rentals'); ?>
...
function initDirectionsPage() {
    ...
    if (typeof google === 'undefined' || typeof google.maps === 'undefined') {
        ...
        <?php else: ?>
            ...
            script.src = 'https://maps.googleapis.com/maps/api/js?key=<?php echo e($googleMapsApiKey); ?>&libraries=places,geometry&callback=initGoogleMap';
            script.async = true;
            script.defer = true;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\FABRICIORENECRESPORO\Desktop\Rentals\reborn-rentals\resources\views/directions.blade.php ENDPATH**/ ?>